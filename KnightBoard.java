...
public class KnightBoard {
  ...
  * @param n the width/height of the board */
  public KnightBoard(int n){
    ...
    currentY= 0;
    moveCount = 1;
    board[currentX][currentY] = moveCount;  // mark the first move on the board
  }
 ...
 public static void main(String[] args){
     ...
     b.printChessBoard();
     System.out.println("x = " + b.getCurrentX() + " y = " + b.getCurrentY()); //TEST
     ...
     b.printChessBoard();
     b.setCurrentX(b.getCurrentX() - 2); //TEST
     b.setCurrentY(b.getCurrentY() + 1); //TEST
     b.setMoveCount(b.getMoveCount() - 1); //TEST
     b.printChessBoard(); //TEST
